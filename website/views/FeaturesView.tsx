        ...
        <div className="max-w-[1280px] mx-auto relative z-10">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="flex flex-col gap-6 flex-1 text-left items-start">
              <div className="flex flex-col gap-4">
                ...
                <h1 className="text-4xl lg:text-6xl font-black leading-tight tracking-[-0.033em]">
                  Master the Realm of <span className="text-primary">ForgeCraft</span>
                </h1>
                <h2 className="text-base lg:text-xl font-normal leading-relaxed text-text-muted">
                  Your complete guide to the features of the ultimate text-based RPG on Telegram. From
                  character stats to guild warfare, explore everything the bot has to offer.
                </h2>
              </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="w-full aspect-video bg-cover bg-center rounded-xl shadow-2xl overflow-hidden border border-surface-border relative group bg-[url('https://github.com/none-git/ForgeCraft/blob/main/website/pictures/background.webp?raw=true')]">
            ...
            {[
              ...
              >
                ...
                <div className="flex flex-col gap-1">
                  <h3 className="text-base font-bold leading-tight">{stat.label}</h3>
          ...
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="flex-1 flex flex-col gap-8">
              <div className="flex flex-col gap-2">
                ...
                <p className="text-base text-text-muted">Manage your loot and prepare for battle.</p>
              </div>
                ...
                <div className="flex items-start gap-4 p-5 rounded-xl border border-surface-border bg-surface-dark hover:bg-surface-border/50 transition-colors">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-1 text-white">
                      <span className="text-primary font-mono text-base mr-2">/inventory</span>
                      Check Bag
                    </h3>
                    <p className="text-sm text-text-muted">
                      View all items you have collected with full details on quantities and stats.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-5 rounded-xl border border-surface-border bg-surface-dark hover:bg-surface-border/50 transition-colors">
                  ...
                  <div>
                    <h3 className="text-lg font-bold mb-1 text-white">
                      <span className="text-primary font-mono text-base mr-2">/equip</span>
                      Gear Up
                    </h3>
                    <p className="text-sm text-text-muted">
                      Equip weapons and armor to apply their stats. Only equipped items grant bonuses.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {[
                {
                  ...
                  desc: (
                    <p>
                      Purchase essential consumables and gear. The shop inventory{' '}
                      <span className="font-bold text-white">resets daily</span>, offering new randomized
                      deals every 24 hours.
                    </p>
                  ),
                },
                {
                  ...
                  desc: (
                    <p>
                      ...
                      <span className="font-bold text-white">5% fee</span> and automatically expire after{' '}
                      <span className="font-bold text-white">7 days</span> if unsold.
                    </p>
                  ),
                },
                {
                  ...
                  desc: (
                    <p>
                      ...
                      <code class="text-primary text-xs bg-black/20 px-1 rounded">/sell_by_id</code> or{' '}
                      <code class="text-primary text-xs bg-black/20 px-1 rounded">/sell_by_rank</code>. Send
                      items directly to friends using
                      <code class="text-primary text-xs bg-black/20 px-1 rounded">/gift</code>.
                    </p>
                  ),
                },
              ].map((item, idx) => (
                ...
                >
                  <div
                    className={`w-full aspect-video bg-cover bg-center rounded-lg overflow-hidden relative shadow-lg bg-[url('https://github.com/none-git/ForgeCraft/blob/main/website/pictures/${item.img}.webp?raw=true')]`}
                  >
        ...
        <div className="max-w-[1280px] mx-auto px-4 lg:px-10 flex flex-col gap-20">
          <div className="flex flex-col md:flex-row gap-10 items-center">
            <div className="w-full md:w-1/2">
              <div className="w-full aspect-[4/3] bg-cover bg-center rounded-xl shadow-2xl border border-surface-border relative overflow-hidden bg-[url('https://github.com/none-git/ForgeCraft/blob/main/website/pictures/map.webp?raw=true')]">
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
                <div className="absolute bottom-6 left-6">
                  <span className="text-white font-bold text-xl block">The Forge Kingdom</span>
            ...
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              ...
              <h3 className="text-3xl font-bold text-white">Adventure & Exploration</h3>
              <p className="text-text-muted text-lg leading-relaxed">
                The world is vast. Use{' '}
                <code className="text-primary bg-primary/10 px-1 py-0.5 rounded text-sm">/map</code> to
                navigate regions and locate dungeons. Use{' '}
                <code className="text-primary bg-primary/10 px-1 py-0.5 rounded text-sm">/adventure</code> to
                explore your current location, fight mobs, and earn valuable rewards and XP.
              </p>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-center">
            <div className="w-full md:w-1/2 flex flex-col gap-6">
              ...
              <p className="text-text-muted text-lg leading-relaxed">
                ...
                . Challenge rivals, place bets on your victory, and claim the loser's coin.
              </p>
              <ul className="space-y-3">
                <li className="flex items-center gap-3 text-text-muted bg-background-dark/50 p-3 rounded-lg border border-surface-border">
                ...
                <li className="flex items-center gap-3 text-text-muted bg-background-dark/50 p-3 rounded-lg border border-surface-border">
                  <span className="material-symbols-outlined text-red-500">casino</span>
                  <span>Betting system (Winner takes the pot)</span>
                </li>
              </ul>
            </div>
            <div className="w-full md:w-1/2">
              <div className="w-full aspect-[4/3] bg-cover bg-center rounded-xl shadow-2xl border border-surface-border relative overflow-hidden bg-[url('https://github.com/none-git/ForgeCraft/blob/main/website/pictures/duel.webp?raw=true')]">
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent"></div>
              </div>
            </div>
          </div>
